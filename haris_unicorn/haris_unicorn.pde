...
void setup() {
  ...
  rainbow = loadImage("rainbow-with-clouds-clipart-jTxE6jrec.jpeg"); 
...
background(rainbow);
  ...
  unicorn = loadImage("badb53b608fc98fc8020a57911d7fee0.png"); // 5. Change this to match your file name.
}
